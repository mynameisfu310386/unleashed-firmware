...
MJDuckyKey mj_ducky_keys[] = {{" ", 32, 0},          {"!", 33, 2},          {"\"", 34, 2},
                              {"#", 35, 0},          {"$", 36, 2},          {"%", 37, 2},
                              {"&", 38, 2},          {"'", 39, 2},          {"(", 40, 2},
                              {")", 41, 2},          {"*", 42, 2},          {"+", 43, 0},
                              {",", 44, 0},          {"-", 45, 0},          {".", 46, 0},
                              {"/", 47, 2},          {"0", 48, 0},          {"1", 49, 0},
                              {"2", 50, 0},          {"3", 51, 0},          {"4", 52, 0},
                              {"5", 53, 0},          {"6", 54, 0},          {"7", 55, 0},
                              {"8", 56, 0},          {"9", 57, 0},          {":", 58, 2},
                              {";", 59, 2},          {"<", 60, 0},         {"=", 61, 2},
                              {">", 62, 2},         {"?", 63, 2},          {"@", 64, 2},
                              {"A", 65, 2},           {"B", 66, 2},           {"C", 67, 2},
                              {"D", 68, 2},           {"E", 69, 2},           {"F", 70, 2},
                              {"G", 71, 2},          {"H", 72, 2},          {"I", 73, 2},
                              {"J", 74, 2},          {"K", 75, 2},          {"L", 76, 2},
                              {"M", 77, 2},          {"N", 78, 2},          {"O", 79, 2},
                              {"P", 80, 2},          {"Q", 81, 2},          {"R", 82, 2},
                              {"S", 83, 2},          {"T", 84, 2},          {"U", 85, 2},
                              {"V", 86, 2},          {"W", 87, 2},          {"X", 88, 2},
                              {"Y", 89, 2},          {"Z", 90, 2},          {"[", 91, 64},
                              {"\\", 92, 64},        {"]", 93, 64},         {"^", 94, 0},
                              {"_", 95, 2},          {"`", 96, 2},          {"a", 97, 0},
                              {"b", 98, 0},           {"c", 99, 0},           {"d", 100, 0},
                              {"e", 101, 0},           {"f", 102, 0},           {"g", 103, 0},
                              {"h", 104, 0},          {"i", 105, 0},          {"j", 106, 0},
                              {"k", 107, 0},          {"l", 108, 0},          {"m", 109, 0},
                              {"n", 110, 0},          {"o", 111, 0},          {"p", 112, 0},
                              {"q", 113, 0},          {"r", 114, 0},          {"s", 115, 0},
                              {"t", 116, 0},          {"u", 117, 0},          {"v", 118, 0},
                              {"w", 119, 0},          {"x", 120, 0},          {"y", 121, 0},
                              {"z", 122, 0},          {"{", 123, 64},         {"|", 124, 64},
                              {"}", 125, 64},         {"~", 126, 64},         {"BACKSPACE", 42, 0},
                              {" ", 44, 0},          {"¤", 8, 64},          {"§", 32, 2},
                              {"°", 53, 2},          {"²", 31, 64},         {"³", 32, 64},
                              {"Ä", 52, 2},          {"Ö", 51, 2},          {"Ü", 47, 2},
                              {"ß", 45, 0},          {"ä", 52, 0},          {"ö", 51, 0},
                              {"ü", 47, 0},          {"€", 8, 64},          {"LEFT", 80, 0},
